...
>
  ...
  >
    ...
    <div className='md:flex  justify-center items-center my-10 md:my-8 w-[330px] md:w-full'>
        <p className='transform -translate-x-[50px] md:translate-x-[140px]  translate-y-[40px] md:-translate-y-[370px] -rotate-45  bg-[#FC746C] rounded-md h-[35px] w-[180px]  md:w-[180px] text-center flex justify-center items-center gap-2 text-white'> <CiHome /> Dashboard</p>

    <Image src={dashboard} alt='dashboard'/>

    </div>
    <div className='md:flex  justify-center items-center my-10 md:my-8 w-[330px] md:w-full '>
        <p className='transform translate-x-[200px] md:translate-x-[1050px]  translate-y-[50px] md:-translate-y-[340px] rotate-45  bg-[#FC746C] rounded-md h-[35px] w-[180px]  md:w-[180px] text-center flex justify-center items-center gap-2 text-white'> <PiBuildingApartment /> Shop</p>
    ...
    <div className='flex justify-around items-center bg-[#FC746C] my-5'>
    <div className=' py-8'>
        ...
        <div>
            <button className='bg-white px-6 text-[#FC746C] font-semibold font-[Poppins] text-[18px] rounded-md h-[44px]'>Start For Free</button>
        </div>
    </div>
