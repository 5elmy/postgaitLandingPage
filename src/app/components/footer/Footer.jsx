  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16  lg:px-4 lg:pt-24 ">
    ...
    <div className="mt-12 border-t-2 border-white pt-6">
      <div className="text-center sm:flex sm:justify-between sm:text-left">
        <p className="text-sm text-[#461A2D]">
        © 2023 POSTGAIT Inc.

        </p>

        <p className="mt-4 text-sm text-[#461A2D] sm:order-first sm:mt-0">© 2023 POSTGAIT.com, subsidiary of Iktsar Elzaman. All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>
