...
export default function Features() {
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 ">
    <div className="mx-auto z-10 text-center">
      <h2 className="text-3xl font-bold text-[#4D1A2D] text-center sm:text-[32px]">The features of Postgait are many waiting for you!</h2>

      <p className="mt-4 z-10 text-gray-300 font-[Cairo] text-[16px]  text-center">
